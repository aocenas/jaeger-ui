...
export default function ReferenceLink(props) {
    ...
    if (reference.span) {
        return (<a role="button" onClick={() => focusSpan(reference.spanID)} className={className} {...otherProps}>
        {children}
      </a>);
    }
    return (<ExternalLinkContext.Consumer>
      {createLinkToExternalSpan => {
        ...
        return (<a href={createLinkToExternalSpan(reference.traceID, reference.spanID)} target="_blank" rel="noopener noreferrer" className={className} {...otherProps}>
            {children}
          </a>);
    }}
