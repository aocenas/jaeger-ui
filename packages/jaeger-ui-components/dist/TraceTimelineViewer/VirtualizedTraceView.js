...
export default class VirtualizedTraceView extends React.Component {
    ...
    renderSpanDetailRow(span, key, style, attrs) {
        ...
        const color = colorGenerator.getColorByKey(serviceName);
        const styles = getStyles();
        return (React.createElement("div", Object.assign({ className: styles.row, key: key, style: Object.assign({}, style, { zIndex: 1 }) }, attrs),
            React.createElement(SpanDetailRow, { color: color, columnDivision: spanNameColumnWidth, onDetailToggled: detailToggle, detailState: detailState, linksGetter: linksGetter, logItemToggle: detailLogItemToggle, logsToggle: detailLogsToggle, processToggle: detailProcessToggle, referencesToggle: detailReferencesToggle, warningsToggle: detailWarningsToggle, span: span, tagsToggle: detailTagsToggle, traceStartTime: trace.startTime, focusSpan: focusSpan, hoverIndentGuideIds: hoverIndentGuideIds, addHoverIndentGuideId: addHoverIndentGuideId, removeHoverIndentGuideId: removeHoverIndentGuideId })));
    }
    render() {
        const styles = getStyles();
        return (React.createElement("div", { className: styles.spans },
            React.createElement(ListView, { ref: this.setListView, dataLength: this.rowStates.length, itemHeightGetter: this.getRowHeight, itemRenderer: this.renderRow, viewBuffer: 300, viewBufferMin: 100, itemsWrapperClassName: styles.rowsWrapper, getKeyFromIndex: this.getKeyFromIndex, getIndexFromKey: this.getIndexFromKey, windowScroller: true })));
    }
}
