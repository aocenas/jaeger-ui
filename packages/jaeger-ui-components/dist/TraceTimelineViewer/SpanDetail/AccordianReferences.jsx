...
export function References(props) {
    ...
    return (<div className={cx(styles.ReferencesList, 'u-simple-scrollbars')}>
      <ul className={styles.list}>
        {data.map(reference => {
        return (<li className={styles.item} key={`${reference.spanID}`}>
              <ReferenceLink reference={reference} focusSpan={focusSpan}>
                <span className={styles.itemContent}>
                  {reference.span ? (<span>
                    ...
                    </span>) : (<span className="span-svc-name">&lt; span in another trace &gt;</span>)}
