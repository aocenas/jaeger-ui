...
export default function AccordianText(props) {
    ...
    return (React.createElement("div", { className: className || '' },
        React.createElement("div", Object.assign({ className: cx(styles.header, headerClassName) }, headerProps, { "data-test-id": "AccordianText--header" }),
            arrow,
            " ",
            ...
            data.length,
            ")"),
        isOpen && React.createElement(TextList, { data: data })));
}
