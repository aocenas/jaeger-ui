...
export const LinkValue = (props) => {
    ...
    return (<a href={props.href} title={props.title} target="_blank" rel="noopener noreferrer">
...
const linkValueList = (links) => (<UIMenu>
...
export default function KeyValuesTable(props) {
    ...
    const styles = getStyles();
    return (<div className={cx(styles.KeyValueTable, 'u-simple-scrollbars')} data-test-id="KeyValueTable">
      <table className="u-width-100">
        ...
        <tr className={styles.row} key={`${row.key}-${i}`}>
                ...
                <td className={styles.copyColumn}>
                  <CopyIcon className={styles.copyIcon} copyText={JSON.stringify(row, null, 2)} tooltipTitle="Copy JSON"/>
                </td>
              </tr>);
    })}
        </tbody>
