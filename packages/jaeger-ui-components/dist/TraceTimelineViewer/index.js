...
export default class TraceTimelineViewer extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement(ExternalLinkContext.Provider, { value: createLinkToExternalSpan },
            React.createElement("div", { className: styles.TraceTimelineViewer },
                ...
                React.createElement(VirtualizedTraceView, Object.assign({}, rest, traceTimeline, { setSpanNameColumnWidth: setSpanNameColumnWidth, currentViewRangeTime: viewRange.time.current })))));
    }
}
