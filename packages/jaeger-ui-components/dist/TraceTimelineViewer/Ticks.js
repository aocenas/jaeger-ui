...
export default function Ticks(props) {
    ...
    for (let i = 0; i < numTicks; i++) {
        ...
        ticks.push(React.createElement("div", { key: portion, className: styles.tick, style: {
                left: `${portion * 100}%`,
            } }, labels && (React.createElement("span", { className: cx(styles.tickLabel, { [styles.tickLabelEndAnchor]: portion >= 1 }) }, labels[i]))));
    }
    return React.createElement("div", { className: styles.Ticks }, ticks);
}
Ticks.defaultProps = {
    endTime: null,
    showLabels: null,
