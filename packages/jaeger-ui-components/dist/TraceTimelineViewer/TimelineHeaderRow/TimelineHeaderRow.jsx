...
export default function TimelineHeaderRow(props) {
    ...
    return (<TimelineRow className={styles.TimelineHeaderRow} data-test-id="TimelineHeaderRow">
      <TimelineRow.Cell className="ub-flex ub-px2" width={nameColumnWidth}>
        ...
        <TimelineCollapser onCollapseAll={onCollapseAll} onExpandAll={onExpandAll} onCollapseOne={onCollapseOne} onExpandOne={onExpandOne}/>
      </TimelineRow.Cell>
      <TimelineRow.Cell width={1 - nameColumnWidth}>
        <TimelineViewingLayer boundsInvalidator={nameColumnWidth} updateNextViewRangeTime={updateNextViewRangeTime} updateViewRangeTime={updateViewRangeTime} viewRangeTime={viewRangeTime}/>
