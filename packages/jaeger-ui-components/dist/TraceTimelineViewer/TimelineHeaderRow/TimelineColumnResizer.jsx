...
export default class TimelineColumnResizer extends React.PureComponent {
    ...
    render() {
        ...
        return (<div className={styles.TimelineColumnResizer} ref={this._setRootElm} data-test-id="TimelineColumnResizer">
        <div className={cx(styles.gripIcon, isDragging && styles.gripIconDragging)} style={gripStyle} data-test-id="TimelineColumnResizer--gripIcon"/>
        <div aria-hidden className={cx(styles.dragger, isDragging && styles.draggerDragging, isDraggingRight && styles.draggerDraggingRight, isDraggingLeft && styles.draggerDraggingLeft)} onMouseDown={this._dragManager.handleMouseDown} style={draggerStyle} data-test-id="TimelineColumnResizer--dragger"/>
      </div>);
    }
}
