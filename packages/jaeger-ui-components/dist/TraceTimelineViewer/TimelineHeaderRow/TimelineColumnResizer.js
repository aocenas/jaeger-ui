...
export default class TimelineColumnResizer extends React.PureComponent {
    constructor(props) {
        ...
        this._handleDragEnd = ({ manager, value }) => {
            manager.resetBounds();
    ...
    render() {
        ...
        return (React.createElement("div", { className: styles.TimelineColumnResizer, ref: this._setRootElm, "data-test-id": "TimelineColumnResizer" },
            React.createElement("div", { className: cx(styles.gripIcon, isDragging && styles.gripIconDragging), style: gripStyle, "data-test-id": "TimelineColumnResizer--gripIcon" }),
            React.createElement("div", { "aria-hidden": true, className: cx(styles.dragger, isDragging && styles.draggerDragging, isDraggingRight && styles.draggerDraggingRight, isDraggingLeft && styles.draggerDraggingLeft), onMouseDown: this._dragManager.handleMouseDown, style: draggerStyle, "data-test-id": "TimelineColumnResizer--dragger" })));
    }
}
