...
function getMarkers(viewStart, viewEnd, from, to, isShift) {
    ...
    return (<div className={cx(styles.dragged, styles.draggedDraggingLeft, cls)} style={{ left, width }} data-test-id="Dragged"/>);
}
/**
...
export default class TimelineViewingLayer extends React.PureComponent {
    ...
    render() {
        ...
        const styles = getStyles();
        return (<div aria-hidden className={styles.TimelineViewingLayer} ref={this._setRoot} onMouseDown={this._draggerReframe.handleMouseDown} onMouseLeave={this._draggerReframe.handleMouseLeave} onMouseMove={this._draggerReframe.handleMouseMove} data-test-id="TimelineViewingLayer">
        {cusrorPosition != null && (<div className={styles.cursorGuide} style={{ left: cusrorPosition }} data-test-id="TimelineViewingLayer--cursorGuide"/>)}
