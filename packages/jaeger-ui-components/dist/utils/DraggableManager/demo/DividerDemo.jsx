...
export default class DividerDemo extends React.PureComponent {
    ...
    render() {
        ...
        return (<div className="DividerDemo--realm" ref={this._setRealm}>
        <div aria-hidden className="DividerDemo--divider" onMouseDown={this._dragManager.handleMouseDown} style={style}/>
      </div>);
    }
}
