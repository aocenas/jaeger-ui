        ...
        return (React.createElement("div", { className: "DraggableManagerDemo" },
            ...
            React.createElement("section", { className: "DraggableManagerDemo--scenario" },
                ...
                React.createElement("div", { className: "DraggableManagerDemo--realm" },
                    React.createElement(DividerDemo, { position: dividerPosition, updateState: this._udpateState }))),
            React.createElement("section", { className: "DraggableManagerDemo--scenario" },
                ...
                React.createElement("div", { className: "DraggableManagerDemo--realm" },
                    React.createElement(RegionDemo, { regionCursor: regionCursor, regionDragging: regionDragging, updateState: this._udpateState })))));
    }
}
