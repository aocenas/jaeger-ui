...
export default class RegionDemo extends React.PureComponent {
    ...
    render() {
        ...
        return (<div aria-hidden className="RegionDemo--realm" onMouseDown={this._dragManager.handleMouseDown} onMouseMove={this._dragManager.handleMouseMove} onMouseLeave={this._dragManager.handleMouseMove} ref={this._setRealm}>
        {regionElm}
        {cursorElm}
      </div>);
    }
